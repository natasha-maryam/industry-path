...
class TagNormalizationService:
    ...
    def __init__(self) -> None:
        self.families: list[TagFamily] = [
            ...
            TagFamily("PCV", "PCV", "control_valve", re.compile(r"\bPCV[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            TagFamily("TCV", "TCV", "control_valve", re.compile(r"\bTCV[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            ...
            TagFamily("TIT", "TIT", "temperature_transmitter", re.compile(r"\bTIT[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            TagFamily("TT", "TT", "temperature_transmitter", re.compile(r"\bTT[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            ...
            TagFamily("CMP", "CMP", "compressor", re.compile(r"\bCMP[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            ...
            TagFamily("MTR", "MTR", "motor", re.compile(r"\bMTR[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            TagFamily("VFD", "VFD", "vfd", re.compile(r"\bVFD[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            TagFamily("PNL", "PNL", "panel", re.compile(r"\bPNL[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            ...
            TagFamily("RCT", "RCT", "reactor", re.compile(r"\bRCT[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            TagFamily("FIL", "FIL", "filter", re.compile(r"\bFIL[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            TagFamily("HX", "HX", "heat_exchanger", re.compile(r"\bHX[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            TagFamily("BLR", "BLR", "boiler", re.compile(r"\bBLR[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            TagFamily("CLR", "CLR", "cooler", re.compile(r"\bCLR[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            TagFamily("PIPE", "PIPE", "pipe", re.compile(r"\bPIPE[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
            TagFamily("MAN", "MAN", "manifold", re.compile(r"\bMAN[-_ ]?(\d{2,5})\b", re.IGNORECASE)),
        ]
